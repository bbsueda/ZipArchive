...
int _zipOpenEntry(zipFile entry, NSString *name, const zip_fileinfo *zipfi, int level, NSString *password, BOOL aes)
{
    // Supports windows outlook(Shift_JIS)
    const char *afileName;
    afileName = [name cStringUsingEncoding:NSShiftJISStringEncoding];

    return zipOpenNewFileInZip5(entry, afileName, zipfi, NULL, 0, NULL, 0, NULL, 0, 0, Z_DEFLATED, level, 0, -MAX_WBITS, DEF_MEM_LEVEL, Z_DEFAULT_STRATEGY, password.UTF8String, aes, 0);
}
